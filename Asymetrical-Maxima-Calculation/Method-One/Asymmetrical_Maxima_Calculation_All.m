...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                ...
                % Script to Go through A Set Number of Time Points and Calculate the Angle:
                    ...
                    for Fourth_Index = round(QRS_On_Time):(round(QRS_On_Time + 25))
                        
                        Time_Point = Fourth_Index;
...
% %                                             hold off;
                                ...
                                % Cluster to Get Two Points:
                                    ...
                                    if Number_of_Clusters ~= 2
                                        ...
                                        Asymmetrical_Angle.Time_Point(Fourth_Index, 1).Run(First_Index, 1).Beat(Third_Index, 1) = NaN;
...
% %                                                     hold off;
                                            ...
                                            Asymmetrical_Angle.Time_Point(Fourth_Index, 1).Run(First_Index, 1).Beat(Third_Index, 1) = atand(Polyfit_Results(1));

                                    end
                                    
                            clearvars -except Asymmetrical_Angle Fourth_Index QRS_On_Time Interpolated_ECG_Signal Third_Index Number_of_Beats_per_Run First_Index Run_Values Points Faces Grid_Resolution Run_Number
                                    
                    end
                    
                    clearvars -except Asymmetrical_Angle QRS_On_Time Third_Index Number_of_Beats_per_Run First_Index Run_Values Points Faces Grid_Resolution Run_Number       
