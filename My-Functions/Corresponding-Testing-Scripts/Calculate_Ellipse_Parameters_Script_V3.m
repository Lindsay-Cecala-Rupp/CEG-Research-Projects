...
% Load in Relevant Variables:
    ...
    % Load in Data:
        ...
        Ellipse_Structure = load('/Users/lindsayrupp/Documents/GitHub/CEG-Research-Projects/Breakthrough-Site-Angle-Calculation/Simulated-Version/Other-Script-Data-for-Intermediate-Steps/Ellipse_Structure_910.mat');
            Ellipse_Structure = Ellipse_Structure.Ellipse_Structure;
            
        Horizontal_Line = load('/Users/lindsayrupp/Documents/GitHub/CEG-Research-Projects/Breakthrough-Site-Angle-Calculation/Simulated-Version/Other-Script-Data-for-Intermediate-Steps/Horizontal_Line_910.mat');
            Horizontal_Line = Horizontal_Line.Horizontal_Line;
        
        Vertical_Line = load('/Users/lindsayrupp/Documents/GitHub/CEG-Research-Projects/Breakthrough-Site-Angle-Calculation/Simulated-Version/Other-Script-Data-for-Intermediate-Steps/Vertical_Line_910.mat');
...
% Script to Determine Angle of the Long Axis of the Ellipse:
        ...
        % Plot to Validate Results:
            ...
            figure(1);
                ...
                hold on;
                    ...
                    scatter(Centered_Vertical_Line(1, Positive_X_Vertical_Line_Coordinate), Centered_Vertical_Line(2, Positive_X_Vertical_Line_Coordinate), 'ro');
                    scatter(Centered_Horizontal_Line(1, Positive_X_Horizontal_Line_Coordinate), Centered_Horizontal_Line(2, Positive_X_Horizontal_Line_Coordinate), 'ro');
    ...
    % Long Axis:
        ...
        if Maximum_Length_Location == 1
            ...
            Long_Axis_Point_of_Interest = Centered_Vertical_Line(:, Positive_X_Vertical_Line_Coordinate);
            ...
            if Long_Axis_Point_of_Interest(2) < 0
                
                Ellipse_Information.Angle_for_Long_Axis = -1 * Ellipse_Information.Angle_for_Long_Axis;
        ...
        elseif Maximum_Length_Location == 2
            ...
            Long_Axis_Point_of_Interest = Centered_Horizontal_Line(:, Positive_X_Horizontal_Line_Coordinate);
                Long_Axis_Point_of_Interest = [Long_Axis_Point_of_Interest; 0];
