function [Global_Projected_Points, Implemented_Points] = Global_Plane_Fitting_Function_Long_Axis(Centered_Breakthrough_Site_Centroid, Centered_Activated_Electrode_X_Location, Centered_Activated_Electrode_Y_Location, Centered_Activated_Electrode_Z_Location)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    % Create a Vector from the Sock Centroid (Origin) to the Breakthrough Site Centroid:
        ...
        % Breakthrough Site Vector:
            ...
            Breakthrough_Site_Vector = [Centered_Breakthrough_Site_Centroid(1); Centered_Breakthrough_Site_Centroid(2); Centered_Breakthrough_Site_Centroid(3)];

            Breakthrough_Site_Points = [Centered_Activated_Electrode_X_Location, Centered_Activated_Electrode_Y_Location, Centered_Activated_Electrode_Z_Location]';
