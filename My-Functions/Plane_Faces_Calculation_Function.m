function [Faces_X_Coordinates, Faces_Y_Coordinates, Faces_Z_Coordinates] = Plane_Faces_Calculation_Function(Points, Faces, Activation_Times)

    % Find the First Activated Electrode:

        [~, First_Activated_Electrode] = min(Activation_Times);
