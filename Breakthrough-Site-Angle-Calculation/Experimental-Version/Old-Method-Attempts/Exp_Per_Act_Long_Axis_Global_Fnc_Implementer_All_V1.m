...
% Script to Input "Magic Number" Variables and Data:
    ...
    % Load in Relevant Variables:
        ...
        Percent_Values = [0.05, 0.10]; %(0:5:50)/100; % Go Through Percentages from 1% to 50%
                ...
                % Use Try-Catch to See What Files MATLAB Can/Can't Find:
                    ...
                    for Second_Index = 1:25
                        ...
                        try
                            ...
                            Time_Signal = load(strcat('/Users/lindsayrupp/Documents/CEG-Research/Pacing-Experiment-Data/14-10-27/Experimental-Data/PFEIFER-Processed-Data-Old/PFEIFER-Processed-Runs/Run', Number_of_Zeros, num2str(Run_Number), '-b', num2str(Second_Index),'-cs.mat'));
                ...
                for Third_Index = 1:Number_of_Beats_per_Run
                    ...
                    % Load in Time Signal Again:
                        if Third_Index < Number_of_Beats_per_Run
                            ...
                            Time_Signal = load(strcat('/Users/lindsayrupp/Documents/CEG-Research/Pacing-Experiment-Data/14-10-27/Experimental-Data/PFEIFER-Processed-Data-Old/PFEIFER-Processed-Runs/Run', Number_of_Zeros, num2str(Run_Number), '-b', num2str(Third_Index),'-cs.mat'));
                        ...
                        elseif Third_Index == Number_of_Beats_per_Run
                            ...
                            Time_Signal = load(strcat('/Users/lindsayrupp/Documents/CEG-Research/Pacing-Experiment-Data/14-10-27/Experimental-Data/PFEIFER-Processed-Data-Old/PFEIFER-Processed-Runs/Run', Number_of_Zeros, num2str(Run_Number), '-cs.mat'));
