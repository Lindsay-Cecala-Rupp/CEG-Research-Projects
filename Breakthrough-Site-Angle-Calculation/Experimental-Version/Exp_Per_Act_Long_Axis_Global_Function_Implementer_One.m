            ...
            % Determine which Direction the Apex of the Heart is Located Corresponding to the Ellipsoid Vectors:
                ...
                % Apply Rotation:
                    ...
                    % Project Breakthrough Site Vector to Y-Axis:
                        ...
                        %Rotate_to_X_Axis_Values = vrrotvec(Rotated_Desired_Vector_Two, Origin_Y_Vector);
                    ...
                    % Remove Coordinate that was Not Rotated About:
                        ...
                        %Global_Projected_Points = [Rotated_Twice_Breakthrough_Site_Points(:, 1), Rotated_Twice_Breakthrough_Site_Points(:, 3)];
