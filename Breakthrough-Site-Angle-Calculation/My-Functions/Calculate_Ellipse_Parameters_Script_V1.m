...
% Load in Relevant Variables:
    ...
    % Load in Data:
        ...
        Ellipse_Structure = load('/Users/lindsayrupp/Documents/CEG-Research/Breakthrough-Site-Angle-Calculation/Stimulated-Version/Other-Script-Data-for-Intermediate-Steps/Ellipse_Structure_910.mat');
            Ellipse_Structure = Ellipse_Structure.Ellipse_Structure;
            
        Horizontal_Line = load('/Users/lindsayrupp/Documents/CEG-Research/Breakthrough-Site-Angle-Calculation/Stimulated-Version/Other-Script-Data-for-Intermediate-Steps/Horizontal_Line_910.mat');
            Horizontal_Line = Horizontal_Line.Horizontal_Line;
        
        Vertical_Line = load('/Users/lindsayrupp/Documents/CEG-Research/Breakthrough-Site-Angle-Calculation/Stimulated-Version/Other-Script-Data-for-Intermediate-Steps/Vertical_Line_910.mat');
    ...
    % Long Axis:
        ...
        if Maximum_Length_Location == 1
            ...
            % Plot Line Going from End Point on Fitted Line:
                ...
                [Minimum_Y_Value_Long_Axis, Minimum_Y_Location_Long_Axis] = min(Vertical_Line(2, :));
                [Maximum_Y_Value_Long_Axis, Maximum_Y_Location_Long_Axis] = max(Vertical_Line(2, :));
                [Minimum_X_Value_Long_Axis, Minimum_X_Location_Long_Axis] = min(Vertical_Line(1, :));
        ...
        elseif Maximum_Length_Location == 2
            ...
            % Plot Line Going from End Point on Fitted Line:
                ...
                [Minimum_Y_Value_Long_Axis, Minimum_Y_Location_Long_Axis] = min(Horizontal_Line(2, :));
                [Maximum_Y_Value_Long_Axis, Maximum_Y_Location_Long_Axis] = max(Horizontal_Line(2, :));
                [Minimum_X_Value_Long_Axis, Minimum_X_Location_Long_Axis] = min(Horizontal_Line(1, :));
    ...
    % Short Axis:
        ...
        if Minimum_Length_Location == 1
            ...
            % Plot Line Going from End Point on Fitted Line:
                ...
                [Maximum_Y_Value_Short_Axis, Maximum_Y_Location_Short_Axis] = max(Vertical_Line(2, :));
                [Minimum_X_Value_Short_Axis, Minimum_X_Location_Short_Axis] = min(Vertical_Line(1, :));
                [Maximum_X_Value_Short_Axis, Maximum_X_Location_Short_Axis] = max(Vertical_Line(1, :));
            ...
            % Create Vectors Corresponding to Lines:
                ...
                if Slope_Short_Axis < 0
                    ...
                    Ellipse_Information.Angle_for_Short_Axis = atan2d(norm(cross(Vector_One_Short_Axis, Vector_Two_Short_Axis)), dot(Vector_One_Short_Axis, Vector_Two_Short_Axis));
                        Ellipse_Information.Angle_for_Short_Axis = -1 * Ellipse_Information.Angle_for_Short_Axis;
        ...
        elseif Minimum_Length_Location == 2
            ...
            % Plot Line Going from End Point on Fitted Line:
                ...
                [Maximum_Y_Value_Short_Axis, Maximum_Y_Location_Short_Axis] = max(Horizontal_Line(2, :));
                [Minimum_X_Value_Short_Axis, Minimum_X_Location_Short_Axis] = min(Horizontal_Line(1, :));
                [Maximum_X_Value_Short_Axis, Maximum_X_Location_Short_Axis] = max(Horizontal_Line(1, :));
