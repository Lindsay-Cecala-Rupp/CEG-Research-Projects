...
% Load in Relevant Variables:
    ...
    % Load in Data:
        ...
        Global_Projected_Points = load('/Users/lindsayrupp/Documents/CEG-Research/Breakthrough-Site-Angle-Calculation/Stimulated-Version/Other-Script-Data-for-Intermediate-Steps/Global_Projected_Points_12.mat');
            Global_Projected_Points = Global_Projected_Points.Global_Projected_Points;
...
% Script to Plot the Resulting in Ellipse if One was Fit:
            ...
            % Plot the Ellipse:
                ...
                figure(1)
                    ...
                    hold on;
                        ...
                        scatter(Horizontal_Coordinates, Vertical_Coordinates);
                    
                        plot(New_Vertical_Line(1,:),New_Vertical_Line(2,:),'r');
                        plot(New_Horizontal_Line(1,:),New_Horizontal_Line(2,:),'r');
