function [Ellipse_Information] = Calculate_Ellipse_Parameters_Function_V2(Ellipse_Structure, Horizontal_Line, Vertical_Line)
...
% %                     hold off;
        ...
        % Long Axis:
            ...
            if Maximum_Length_Location == 1
                ...
                % Check to See if the Vectors Are Along the X-Axis or Y-Axis and set the Angle Value Dependent on X or Y:
                
                    if size(Positive_Y_Vertical_Line_Coordinate, 2) == 0
                        
                        if Centered_Vertical_Line(2, 1) == Centered_Vertical_Line(2, 2)
...
% %         
            ...
            elseif Maximum_Length_Location == 2
                ...
                % Check to See if the Vectors Are Along the X-Axis or Y-Axis and set the Angle Value Dependent on X or Y:
                    ...
                    if size(Positive_Y_Horizontal_Line_Coordinate, 2) == 0
                        
                        if Centered_Horizontal_Line(2, 1) == Centered_Horizontal_Line(2, 2)
        ...
        % Short Axis:
            ...
            if Minimum_Length_Location == 1
                ...
                % Check to See if the Vectors Are Along the X-Axis or Y-Axis and set the Angle Value Dependent on X or Y:
                    ...
                    if size(Positive_X_Vertical_Line_Coordinate, 2) == 0
                        
                        if Centered_Vertical_Line(1, 1) == Centered_Vertical_Line(1, 2)
...
% %                                     hold off;
            ...
            elseif Minimum_Length_Location == 2
                ...
                % Check to See if the Vectors Are Along the X-Axis or Y-Axis and set the Angle Value Dependent on X or Y:
                    ...
                    if size(Positive_X_Horizontal_Line_Coordinate, 2) == 0
                        
                        if Centered_Horizontal_Line(1, 1) == Centered_Horizontal_Line(1, 2)
