...
% Script to Input "Magic Number" Variables and Data:
    ...
    % Load in Data:
        ...
        Activation = load('/Users/lindsayrupp/Documents/CEG Research/Breakthrough Site Angle Calculation/Stimulated Version/Data/act_needle_12.txt');
...
% Script to Determine Coordinates in the Breakthrough Site:
    ...
    [Activated_Electrode_X_Location, Activated_Electrode_Y_Location, Activated_Electrode_Z_Location] = Time_Breakthrough_Site_Electrode_Determination_Function(Centered_Upsampled_Points, Upsampled_Activation_Times, Time_Into_QRS_Peak);
