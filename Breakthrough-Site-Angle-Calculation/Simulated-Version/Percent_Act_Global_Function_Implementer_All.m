...
% Script to Input "Magic Number" Variables and Data:
    ...
    % Load in Data:
        ...
        for First_Index = 1:size(Run_Values, 2)
            ...
            Data = load(strcat('/Users/rupp/Documents/GitHub/CEG-Research-Projects/Breakthrough-Site-Angle-Calculation/Simulated-Version/SCIRun-Scripts/Results/14-10-27-Simulated-Electrodes', num2str(Run_Values(1, First_Index)), '.mat'));
                        ...
                        % Script to Calculate the Parameters of the Fitted Ellipse:
                            ...
                            % Check to See if an Ellipse was Fitted in Order to Decide Whether or Not Parameters can be Calculated:
                                ...
                                if size(Ellipse_Structure.a,1) == 0
                                    ...
                                    [Compiled_Ellipse_Information.Run(First_Index).Percent(Second_Index)] = Calculate_Ellipse_Parameters_Function_V2(Ellipse_Structure, Horizontal_Line, Vertical_Line);
