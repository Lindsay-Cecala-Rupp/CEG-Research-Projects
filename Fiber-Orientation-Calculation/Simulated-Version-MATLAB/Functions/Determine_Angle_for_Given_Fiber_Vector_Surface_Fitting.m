...
% Script to Input Variables and Data:
    ...
    % Data:
        ...
        % Previous Script Results:
            ...
            Cylinder_Indicies = load('/Users/lindsayrupp/Documents/GitHub/CEG-Research-Projects/Fiber-Orientation-Calculation/Simulated-Version-MATLAB/Other-Script-Data-for-Intermediate-Steps/Closest_Surface_Radius2_Electrodes12.mat');
...
% Calculate the Angle for Each Fiber in the Cylinder:
    ...
    for First_Index = 733%1:size(Cylinder_Indicies, 1)
