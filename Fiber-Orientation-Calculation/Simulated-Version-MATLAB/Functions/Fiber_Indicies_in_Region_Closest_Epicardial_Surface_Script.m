...
% Script to Input Variables and Data:
    ...
    % Magic Numbers::
        ...
        % Coordinate_of_Interest = [70609.0269937853, 46768.4045896411, 66518.8903804147]/1000; % Epicardium
        Coordinate_of_Interest = [60651.6766677865, 46514.6602504612, 59369.3542404863]/1000; % Endocardium
    ...
    % Data:
        ...
        % Cartesian Model:
            ...
            Heart_Surface = load('/Users/lindsayrupp/Documents/CEG-Research/Pacing-Experiment-Data/14-10-27/Simulated-Data/Geometry-Files/14-10-27-CARP-Epicardial-and-Endocardial-Surface-Blank.mat');
...
% Remove the Inside of the Ventricles from the Heart Surface Variable:
    ...
    % Remove the Base of the Heart to Apply Clustering Technique:
        ...
        Heart_Surface_Index_Desired = find(Heart_Surface(:, 3) > (min(Heart_Surface(:, 3)) + 1));
